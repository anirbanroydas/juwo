...
UNIT_TESTING_NAME = juwotestunit
CONTRACT_TESTING_NAME = juwotestcontract
INTEGRATION_TESTING_NAME = juwotestintegration
COMPONENT_TESTING_NAME = juwotestcomponent
END_TO_END_TESTING_NAME = juwoteste2e
LOAD_TESTING_NAME = juwotestload
...
.PHONY: npmshrinkwrap audit-shrinkwrap npm-setup
...
npm-setup: npmshrinkwrap audit-shrinkwrap
...
test-load:
	bash -c "tests/test.sh $(APP_NAME) load $(LOAD_TESTING_NAME) $(LOAD_TEST_DIR) $(PROJECT_ROOT_DIR) $(CI_SERVER)" 
