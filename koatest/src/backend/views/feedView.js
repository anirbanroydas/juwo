...
// Handler/Controller to handle route POST requests to Feed Home 
const FeedHomePostHandler = function *(next) {
    this.log.debug('Inside Feed Home Post Handler'); 
    ...
    let errorhandler = false;
  	...
  	if (!this.state.isAuthenticated){
	    ...
	    return;
      	...
      	let isValid = validator.isValidFeedHomeRequestData(this);
		...
		// get feed from redis
		let data = yield cache.get_feed_home(sess.info.userid, this.request.body.cursor, this.request.body.count);
...
exports.FeedHomePostHandler = FeedHomePostHandler;
