...
// Handler/Controller to handle route POST requests to  Livestream User Data
const LivestreamUserPostHandler = function *(next) {
    this.log.debug('Inside User Livestream Post Handler'); 
    ...
    let errorhandler = false;
  	...
  	if (!this.state.isAuthenticated){
	    ...
	    return;
      	...
      	let isValid = validator.isValidLivestreamUserRequestData(this);
		...
		// get feed from redis
		let data = yield cache.get_livestream_user(sess.info.userid, this.request.body.cursor, this.request.body.count);
...
exports.LivestreamUserPostHandler = LivestreamUserPostHandler;
